    ...
    <>
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(45,106,79,0.55), transparent 70%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0,255,200,0.22), transparent 70%)",
            animationDelay: "2.5s",
          }}
        />
        <div
        ...
        <div
          ...
          style={{
            ...
            backgroundSize:
              "340px 340px, 280px 280px, 400px 400px, 220px 220px",
          }}
        />
        {/* scanlines */}
        <div
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, transparent 45%, #020a07 100%)",
          }}
        />
      </div>
